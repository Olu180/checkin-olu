...
`git clone https://github.com/Olu180/checkin.git`
...
1. Push the docker image into the ecr repositories
    a. Change directory to the backend app and build the docker image using the following command
    `cd app/backend`
    ...
    b. Change directory to the frontend app and build the docker image using the following command
    `cd ../app/backend`
